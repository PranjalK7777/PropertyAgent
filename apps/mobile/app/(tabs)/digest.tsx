  ...
  if (loading) {
    return (
      <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: '#0f172a' }}>
        ...
        <Text style={{ color: '#475569', marginTop: 12, fontSize: 14 }}>Loading digests...</Text>
      </View>
    );
  }
    ...
    >
      ...
      {digests.length === 0 ? (
        <Animated.View entering={FadeInDown.delay(150)} style={{ alignItems: 'center', justifyContent: 'center', paddingVertical: 60 }}>
          <View style={{
            width: 80, height: 80, borderRadius: 24, backgroundColor: '#1e293b',
      ...
      >
        ...
        {isExpanded && (
          <Animated.View
            ...
            style={{ borderTopWidth: 1, borderTopColor: '#334155', padding: 16 }}
          >
            {/* Stats grid */}
            <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 10, marginBottom: 14 }}>
              {[
                ...
                <View key={label} style={{
                  ...
                  <Text style={{ color: '#64748b', fontSize: 11, marginTop: 2, fontWeight: '500' }}>{label}</Text>
                </View>
              ))}
            </View>
            ...
            {digest.summary && (
              <View style={{
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 8 }}>
                  ...
                  <Text style={{ color: '#a78bfa', fontSize: 10, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1 }}>
                    AI Summary
                  </Text>
                </View>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
              <Ionicons
                ...
                size={14}
                color={digest.sentToWhatsApp ? '#4ade80' : '#f87171'}
              />
